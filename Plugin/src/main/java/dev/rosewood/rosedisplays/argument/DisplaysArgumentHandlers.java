...
public final class DisplaysArgumentHandlers {
    ...
    public static final ArgumentHandler<HologramGroup> HOLOGRAM_GROUP = new HologramGroupArgumentHandler(ROSE_PLUGIN);
    public static final ArgumentHandler<HologramProperty<?>> HOLOGRAM_PROPERTY = new HologramPropertyArgumentHandler();
    public static final ArgumentHandler<HologramType> HOLOGRAM_TYPE = new HologramTypeArgumentHandler();
    ...
    public static final ArgumentHandler<Long> DURATION = new DurationArgumentHandler();
